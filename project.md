...
Generated: 2026-01-17T19:00:21.838Z
...
```json
{
  ...
  "packages": {
    ...
    "node_modules/@nestjs/testing": {
      "version": "11.1.11",
      "resolved": "https://registry.npmjs.org/@nestjs/testing/-/testing-11.1.11.tgz",
...
import { AppRole } from '../types/index.type';
...
import { AppRole, RequestWithUser } from '../types/index.type';
...
## 📄 src/common/types/index.type.ts
...
export class AuthService {
  ...
  async register(dto: RegisterDto, res: Response): Promise<AuthResponseConstant> {
    ...
    await this.updateRefreshTokenInDB(user.id, user.refreshToken);
  ...
  async login(dto: LoginDto, res: Response): Promise<AuthResponseConstant> {
    ...
    if (!user || !(await argon2.verify(user.password, dto.password))) {
      throw new UnauthorizedException('Не правильный логин и/или пароль');
    }
  ...
  async logout(user: RequestWithUser['user'], res: Response) {
...
## 📄 src/modules/auth/constants/auth-response.constant.ts
...
## 📄 src/modules/auth/types/index.type.ts
...
## 📄 src/modules/callbacks/callbacks.controller.ts
...
## 📄 src/modules/callbacks/callbacks.module.ts
...
## 📄 src/modules/callbacks/callbacks.service.ts
...
## 📄 src/modules/callbacks/constants/index.constant.ts
...
## 📄 src/modules/callbacks/dto/create-callback.dto.ts
...
## 📄 src/modules/callbacks/types/index.type.ts
...
## 📄 src/modules/news/constants/index.constant.ts
...
## 📄 src/modules/news/types/index.type.ts
...
## 📄 src/modules/news-categories/constants/index.constant.ts
...
## 📄 src/modules/news-categories/dto/create-news-categories.dto.ts
...
## 📄 src/modules/news-categories/dto/update-news-categories.dto.ts
...
## 📄 src/modules/news-categories/news-categories.controller.ts
...
## 📄 src/modules/news-categories/news-categories.module.ts
...
## 📄 src/modules/news-categories/news-categories.service.ts
...
## 📄 src/modules/news-categories/types/index.type.ts
